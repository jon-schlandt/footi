...
class SettingsViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.register(SettingGroupHeaderView.self, forHeaderFooterViewReuseIdentifier: SettingGroupHeaderView.identifier)
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let header = tableView.dequeueReusableHeaderFooterView(withIdentifier: SettingGroupHeaderView.identifier) as! SettingGroupHeaderView
