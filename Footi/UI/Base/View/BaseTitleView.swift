...
class BaseTitleView: UIView {
    ...
    private let separator: UIView = {
        ...
        separator.backgroundColor = UIColor.Palette.primarySymbol
    ...
    public func setIcon(as icon: String) {
        titleIcon.image = UIImage(systemName: icon)?.withConfiguration(UIImage.SymbolConfiguration(pointSize: 15.0, weight: .light, scale: .medium))
    }
}
