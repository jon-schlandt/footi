...
extension FixturesTableViewController {
    ...
    private func generateFixtureMap() {
        let fixtures = self.model as? [Fixture]
        ...
        fixtures.enumerated().forEach { index, fixture in
            var fixture = fixture
            fixture.status.type = FixtureStatusType.getStatusType(from: fixture.status.short)
            
            #if DEBUG
            fixture.date = setMockDate(using: fixture.date)
            #endif
            
            let m1 = Int(fixture.matchday.replacingOccurrences(of: "Regular Season - ", with: ""))
            ...
            let m2 = Int(pastFixture.matchday.replacingOccurrences(of: "Regular Season - ", with: ""))
