...
class LeadersViewController: BaseViewContoller {
    ...
    override func loadLeagueHeaderDetails() async {
        ...
        self.leagueHeaderDetails.filter = LeagueDataFilter(title: "By category", options: filterOptions)
...
extension LeadersViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.configure(with: leader, filterType: filterValue, isLast: isLast)
        return cell
    }
}
