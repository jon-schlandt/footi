...
extension StandingsViewController {
    ...
    private func livifyTable() async {
        ...
        fixturesInPlay.forEach { fixture in
            ...
            if fixture.homeSide.goals ?? 0 > fixture.awaySide.goals ?? 0 {
                homePointMod = 3
                homeWinMod = 1
                homeDrawMod = 0
                homeLossMod = 0
                ...
                awayDrawMod = 0
                awayLossMod = 1
            } else if fixture.homeSide.goals ?? 0 < fixture.awaySide.goals ?? 0 {
                homePointMod = 0
                homeWinMod = 0
                homeDrawMod = 0
                homeLossMod = 1
            ...
            var homeStanding = standings.first { $0.clubTitle == fixture.homeSide.name }!
            homeStanding.inPlay = true
            homeStanding.matchesPlayed.modifier = 1
            homeStanding.points.modifier = homePointMod
            homeStanding.goalDifference.modifier = (fixture.homeSide.goals ?? 0) - (fixture.awaySide.goals ?? 0)
            ...
            homeStanding.goalsScored.modifier = fixture.homeSide.goals ?? 0
            homeStanding.goalsConceded.modifier = fixture.awaySide.goals ?? 0
            liveStandings.append(homeStanding)
            
            var awayStanding = standings.first { $0.clubTitle == fixture.awaySide.name }!
            awayStanding.inPlay = true
            awayStanding.matchesPlayed.modifier = 1
            awayStanding.points.modifier = awayPointMod
            awayStanding.goalDifference.modifier = (fixture.awaySide.goals ?? 0) - (fixture.homeSide.goals ?? 0)
            ...
            awayStanding.goalsScored.modifier = fixture.awaySide.goals ?? 0
            awayStanding.goalsConceded.modifier = fixture.homeSide.goals ?? 0
